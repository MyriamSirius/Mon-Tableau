...
//*******************************Affichage calendrier********************************************************** */
     ...
     */
    public function save(CalendarRepository $calendarRepository)
    {
      ...
      foreach ($dates as $key => $value) {
        ...
        //$key->format('Y-m-d H:i:s');
        //dump($date);
        // $calendarExist = $calendarRepository->findByDate(\DateTime::createFromFormat('d/m/Y', $key));
        // dump($calendarExist);
        // foreach ($calendarExist as $key => $value) {
        //   dump($value);
        // }
        // die;
